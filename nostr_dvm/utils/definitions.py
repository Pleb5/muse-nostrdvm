...
class EventDefinitions:
    ...
    KIND_GIT_REPOSITORY = Kind(30617)
    KIND_GIT_ISSUE = Kind(1621)
    KIND_GIT_ISSUE_REPLY = Kind(1622)
    KIND_GIT_ISSUE_OPEN = Kind(1630)
    KIND_GIT_ISSUE_RESOLVED = Kind(1631)
    KIND_GIT_ISSUE_CLOSED = Kind(1632)
    KIND_GIT_ISSUE_DRAFT = Kind(1633)
